<template>
    <div class="info-container">
        ...
        <div class="input account-container">
            <el-input class="account" v-model="userinfo.account" style="width: 80%"
        ...
        <div class="function-button">
            ...
            <span class="signin">
                <el-button class="button-right" type="primary" round
                    @Click="login(userinfo.account, userinfo.password)">登录</el-button>
            </span>
        </div>
    </div>
    ...
    if (username != '' && password != '') {
        ...
        switch (result.status) {
            case 200:
                ...
                ElNotification({
                    title: 'Success',
                    message: `登录成功啦,${result.data.account}牢弟`,
                    type: 'success',
                    duration: 2500,
                    offset: 50,
                })
